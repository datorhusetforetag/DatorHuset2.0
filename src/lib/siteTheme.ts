...
export const buildSiteThemeVars = (theme: SiteTheme): CSSProperties => ({
  ...
  ["--site-surface-bg-current" as string]: `light-dark(${theme.surfaceBackground}, ${theme.surfaceBackgroundDark})`,
  ["--site-muted-bg-current" as string]: `light-dark(${theme.mutedBackground}, ${theme.mutedBackgroundDark})`,
  ["--site-card-bg-current" as string]: `light-dark(${theme.cardBackground}, ${theme.cardBackgroundDark})`,
  ["--site-card-border-current" as string]: `light-dark(${theme.cardBorderColor}, ${theme.cardBorderColorDark})`,
  ["--site-text-primary-current" as string]: `light-dark(${theme.textColor}, ${theme.textColorDark})`,
  ["--site-text-muted-current" as string]: `light-dark(${theme.mutedTextColor}, ${theme.mutedTextColorDark})`,
  ["--site-hero-frame-bg-current" as string]: `light-dark(${theme.heroImageFrameBackground}, ${theme.cardBackgroundDark})`,
