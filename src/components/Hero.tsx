...
const FEATURED_COMPUTERS = [
  {
    ...
    price: 31999,
    originalPrice: null,
    availability: 'Preliminär sändningsklarär 4 februari 202...'
  },
  {
    id: '2',
    ...
    price: 17999,
    originalPrice: null,
    availability: 'Preliminär sändningsklarär 14 januari 202...'
  },
  {
    id: '3',
  ...
  },
  {
    ...
    price: 51199,
    originalPrice: null,
    availability: '68 st i lager, produktionstöd 23-24...'
  },
  {
    id: '5',
    ...
    price: 46399,
    originalPrice: null,
    availability: 'Preliminär sändningsklarär 13 jan...'
  }
];
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          ...
          <div className="bg-gray-900 rounded-lg p-8 flex flex-col justify-between min-h-64">
            ...
            <div className="flex gap-2">
              <span className="bg-yellow-400 text-gray-900 px-3 py-1 rounded text-sm font-bold">❤️</span>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              { name: "Datorer & Surfplatta", icon: "💻" },
              { name: "Mobil & klockor", icon: "📱" },
              { name: "TV, ljud & bild", icon: "📺" },
              { name: "Datorutrustning", icon: "⚙️" },
              { name: "Hem & fritid", icon: "🏠" },
              { name: "DatorHuset PC", icon: "🖥️" },
            ].map((category) => (
              <Link
                key={category.name}
                to="/products"
        ...
        <div className="mb-12">
          ...
          <div className="relative">
            ...
            {/* Navigation buttons */}
            <button className="absolute left-0 top-1/3 -translate-y-1/2 -translate-x-4 bg-white border border-gray-200 rounded-full p-2 hover:bg-gray-100 transition-colors">
              <ChevronLeft className="w-6 h-6 text-gray-900" />
            </button>
            <button className="absolute right-0 top-1/3 -translate-y-1/2 translate-x-4 bg-white border border-gray-200 rounded-full p-2 hover:bg-gray-100 transition-colors">
