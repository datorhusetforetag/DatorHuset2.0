...
export const Navbar = () => {
  ...
  const renderSearchDropdown = (isMobile = false) => {
    ...
    return (
      <div
        className={`absolute left-0 right-0 top-full z-50 mt-2 overflow-hidden rounded-xl border border-gray-200 bg-white text-gray-900 shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:text-gray-50 ${
  ...
  return (
    <>
      <AnnouncementBar settings={settings.site.announcement} />
                ...
                <div className="flex min-w-0 items-center gap-2 lg:order-1">
                  ...
                  >
                    <img
                      ...
                      decoding="async"
                    />
                    <span className="max-w-[160px] truncate font-[Orbitron] sm:max-w-none">{navigation.brandName}</span>
                  </Link>
                </div>
                ...
                <div className="flex items-center gap-2 lg:order-4">
                  {isAdmin && (
                    <a
                      ...
                      className="hidden items-center gap-2 rounded-full border border-gray-200 px-3 py-2 text-xs font-semibold text-gray-900 transition-colors hover:border-[#11667b] hover:text-[#11667b] dark:border-gray-700 dark:text-white sm:inline-flex"
                    >
                  ...
                  <div className="relative" onMouseEnter={handleCartEnter} onMouseLeave={handleCartLeave}>
                    <button
                      ...
                      className="relative flex flex-col items-center text-gray-900 transition-colors hover:text-[#11667b] dark:text-white"
                    >
