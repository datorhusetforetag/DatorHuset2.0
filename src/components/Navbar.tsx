      ...
      <div className="bg-gray-100 border-b border-gray-200 text-xs text-gray-600">
        <div className="container mx-auto px-4 py-2 flex justify-between items-center">
          <div className="flex gap-6">
            <span className="hover:text-blue-600 cursor-default">Fordelar for foretag</span>
            <span className="hover:text-blue-600 cursor-default">Support</span>
            <span className="hover:text-blue-600 cursor-default">Fri frakt for Plus</span>
          </div>
          <span className="hover:text-blue-600 cursor-default">Kundservice</span>
        </div>
      </div>
